...
I'm a passionate **Frontend Developer** specializing in building modern, responsive, and user-friendly web applications. With a strong foundation in the **MERN stack** and hands-on experience with **Firebase**, I love creating seamless digital experiences that solve real-world problems.

- 🔭 Currently exploring **Next.js** for server-side rendering and full-stack development
- 💼 Building scalable applications with **React.js**, **Node.js**, and **MongoDB**
...
const currentlyLearning = {
  framework: "Next.js",
  focus: ["Server-Side Rendering", "Static Site Generation", "API Routes"],
  goal: "Building full-stack applications with modern architecture",
  interests: ["Web Performance", "UI/UX Design", "Clean Code Practices"]
};
```
